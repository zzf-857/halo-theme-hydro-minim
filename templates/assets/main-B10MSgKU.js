...
- 描述：${i}${a?`\n- 邮箱：${a}`:``}`;navigator.clipboard.writeText(s).then(()=>{K(`您的友链申请信息已成功复制到剪贴板！请在下方评论区发表评论提交申请。`,{id:`hydro-link-submit-clipboard-success`,title:`信息复制成功`,variant:`success`})}).catch(()=>{K(`自动复制失败，请手动选中表单中的信息进行复制。`,{id:`hydro-link-submit-clipboard-error`,title:`复制提示`,variant:`error`})}),A(o),setTimeout(()=>{let e=document.querySelectorAll(`textarea`),t=!1;if(e.forEach(e=>{let n=e.placeholder||``;(n.includes(`评论`)||n.includes(`说点什么`)||e.className.includes(`comment`)||e.id.includes(`comment`))&&(e.value=s,e.dispatchEvent(new Event(`input`,{bubbles:!0})),e.focus(),t=!0)}),!t&&e.length>0){let t=e[0];t.value=s,t.dispatchEvent(new Event(`input`,{bubbles:!0})),t.focus()}let n=document.getElementById(`comment`);n&&n.scrollIntoView({behavior:`smooth`})},500);return}let r=P(n,`submit`);if(r==null)return;let s={displayName:n.get(`displayName`),url:n.get(`url`),logo:n.get(`logo`)||void 0,email:n.get(`email`),description:n.get(`description`)||void 0,linkPageUrl:n.get(`linkPageUrl`)||void 0,groupName:n.get(`groupName`)||void 0,rssUrl:n.get(`rssUrl`)||void 0},c=document.getElementById(`hydro-link-submit-btn`);K(`正在提交友链申请...`,{id:`hydro-link-submit-pending`,title:`友链申请`,variant:`info`}),k(c,!0,`提交中...`,`提交申请`),t.submit(s,r,i===`none`?void 0:i).then(e=>{if(e.code===200){O(d,e.msg||a.submitSuccess,`success`),u.reset(),window.setTimeout(()=>{A(o)},1500);return}O(d,e.msg||a.submitError,`error`)}).catch(()=>{O(d,a.submitError,`error`)}).finally(()=>{i===`captcha`&&M(`submit`),k(c,!1,``,`提交申请`)})}),v?.addEventListener(`submit`,e=>{e.preventDefault();let t=D();if(!t||typeof t.update!=`function`||!v){O(y,`当前插件不支持在线修改。`,`error`);return}let n=new FormData(v),r=P(n,`update`);if(r==null)return;let o={oldUrl:n.get(`oldUrl`),displayName:n.get(`displayName`),url:n.get(`url`),logo:n.get(`logo`)||void 0,email:n.get(`email`),description:n.get(`description`)||void 0,linkPageUrl:n.get(`linkPageUrl`)||void 0,groupName:n.get(`groupName`)||void 0,rssUrl:n.get(`rssUrl`)||void 0},s=document.getElementById(`hydro-link-update-submit-btn`);K(`正在提交友链修改...`,{id:`hydro-link-update-pending`,title:`友链修改`,variant:`info`}),k(s,!0,`提交中...`,`提交修改`),t.update(o,r,i===`none`?void 0:i).then(e=>{if(e.code===200){O(y,e.msg||a.updateSuccess,`success`),v.reset(),window.setTimeout(()=>{_&&A(_)},1500);return}O(y,e.msg||a.updateError,`error`)}).catch(()=>{O(y,a.updateError,`error`)}).finally(()=>{i===`captcha`&&M(`update`),k(s,!1,``,`提交修改`)})}),window.addEventListener(`hashchange`,()=>{window.location.hash===`#add`?re():window.location.hash===`#edit`&&j()}),ie()}en(),ge(),s(),fn(),pn(),dn(),mn(),yn(),bn(),gn(),xn(),Sn(),Cn(),wn(),jn(),Mn(),hn(),An(),In(),Wn(),zn(),Ln(),Rn(),Gn(),Fn(),Kn(),Pt(),b(),Ct();function Jn(){if(!W)return;document.querySelectorAll(`.hydro-links-grid`).forEach(t=>{let r=Array.from(t.querySelectorAll(`.hydro-link-card`));if(r.length===0)return;e.set(r,{"--hydro-link-reveal-y":`1.4rem`,autoAlpha:0,clipPath:`inset(12% 0% 0% 0% round 0.5rem)`,filter:`blur(10px)`});let i=t=>{let n=Math.abs(t),i=e.utils.clamp(.38,.9,.88-n/3600),a=e.utils.clamp(.035,.13,.13-n/18e3);e.killTweensOf(r),e.to(r,{"--hydro-link-reveal-y":`0rem`,autoAlpha:1,clipPath:`inset(0% 0% 0% 0% round 0.5rem)`,duration:i,ease:`expo.out`,filter:`blur(0px)`,stagger:{each:a,from:`start`}})};n.create({trigger:t,start:`top 84%`,onEnter:e=>i(e.getVelocity()),onEnterBack:e=>i(e.getVelocity()),onLeaveBack:()=>{e.killTweensOf(r),e.set(r,{"--hydro-link-reveal-y":`1.4rem`,autoAlpha:0,clipPath:`inset(12% 0% 0% 0% round 0.5rem)`,filter:`blur(10px)`})}})});let t=Array.from(document.querySelectorAll(`.hydro-link-card`));if(t.length===0)return;let r=[];t.forEach(e=>{let t=null,n=0,i=0,a=0,o=()=>(t=e.getBoundingClientRect(),t),s=()=>{a=0,e.style.setProperty(`--hydro-link-glow-x`,`${n}px`),e.style.setProperty(`--hydro-link-glow-y`,`${i}px`)};e.addEventListener(`pointerenter`,()=>{o()}),e.addEventListener(`pointermove`,e=>{let r=t??o();n=e.clientX-r.left,i=e.clientY-r.top,!a&&(a=window.requestAnimationFrame(s))},{passive:!0}),e.addEventListener(`pointerleave`,()=>{t=null,a&&=(window.cancelAnimationFrame(a),0)}),r.push(()=>{t=null})}),window.addEventListener(`resize`,()=>{r.forEach(e=>e())},{passive:!0})}function Yn(){document.querySelectorAll(`[data-moment]`).forEach((t,r)=>{if(!W){t.classList.add(`is-visible`);return}n.create({trigger:t,start:`top 88%`,onEnter:()=>{e.to(t,{opacity:1,y:0,duration:.6,ease:`expo.out`,delay:r%5*.05,onStart:()=>t.classList.add(`is-visible`)})}})})}function Xn(){document.querySelectorAll(`.hydro-moment__content`).forEach(e=>{e.querySelectorAll(`a.tag`).forEach(e=>e.remove()),e.querySelectorAll(`p`).forEach(e=>{e.textContent?.trim()===``&&e.children.length===0&&e.remove()})})}function Zn(){let e=new Set(Jt(Ut)),t=document.body.dataset.momentUpvoteErrorText||`点赞失败，请稍后再试`;document.querySelectorAll(`[data-moment-upvote]`).forEach(n=>{let r=n.dataset.momentUpvote;r&&(n.classList.toggle(`is-upvoted`,e.has(r)),n.disabled=e.has(r),n.addEventListener(`click`,async()=>{if(!(e.has(r)||n.disabled)){n.disabled=!0;try{let t=await window.fetch(`/apis/api.halo.run/v1alpha1/trackers/upvote`,{body:JSON.stringify({group:`moment.halo.run`,name:r,plural:`moments`}),headers:{"Content-Type":`application/json`},method:`POST`});if(!t.ok)throw Error(`Upvote failed with ${t.status}`);e.add(r),Yt(Ut,Array.from(e)),n.classList.add(`is-upvoted`);let i=document.querySelector(`[data-upvote-moment-name="${CSS.escape(r)}"]`);i&&(i.textContent=String(Number.parseInt(i.textContent||`0`,10)+1)),K(`点赞成功`,{id:`hydro-moment-upvote`,title:`瞬间`,variant:`success`})}catch{n.disabled=!1,K(t,{id:`hydro-moment-upvote`,title:`瞬间`,variant:`error`})}}}))}),document.querySelectorAll(`[data-moment-comment-toggle]`).forEach(e=>{let t=e.dataset.momentCommentToggle,n=t?document.querySelector(`[data-moment-comment="${CSS.escape(t)}"]`):null;n&&e.addEventListener(`click`,()=>{let t=n.hidden===!0;n.hidden=!t,e.classList.toggle(`is-active`,t),e.setAttribute(`aria-expanded`,String(t))})})}function Qn(){if(!zt){document.querySelectorAll(`[data-lightbox-trigger]`).forEach(e=>{e.removeAttribute(`data-lightbox-trigger`),e.removeAttribute(`data-src`),e.removeAttribute(`data-alt`),e instanceof HTMLButtonElement&&(e.type=`button`,e.disabled=!0,e.setAttribute(`aria-disabled`,`true`))});return}let e=document.querySelector(`[data-lightbox]`);if(!e)return;document.body.append(e);let t=e.querySelector(`[data-lightbox-img]`),n=e.querySelector(`[data-lightbox-close]`),r=e.querySelector(`[data-lightbox-prev]`),i=e.querySelector(`[data-lightbox-next]`),a=e.querySelector(`[data-lightbox-counter]`),o=e.querySelector(`[data-lightbox-caption]`),s=Array.from(document.querySelectorAll(`[data-lightbox-trigger]`)),c=0,l=n=>{let l=s[n];if(!l||l.dataset.lightboxDisabled===`true`||l.dataset.mediaState===`error`||l.closest(`[data-media-state='error']`))return;c=n;let u=l.dataset.src??``,d=l.dataset.alt??``,f=l.dataset.caption??d;t&&(t.classList.add(`is-loading`),t.src=u,t.alt=d,t.onload=()=>t.classList.remove(`is-loading`),e.classList.add(`is-open`),e.setAttribute(`aria-hidden`,`false`),document.body.classList.add(`hydro-menu-lock`),G()?.stop?.(),a&&(a.textContent=`${n+1} / ${s.length}`),o&&(o.textContent=f,o.hidden=f.length===0),r&&(r.style.display=s.length>1?``:`none`),i&&(i.style.display=s.length>1?``:`none`))},u=()=>{e.classList.remove(`is-open`),e.setAttribute(`aria-hidden`,`true`),document.body.classList.remove(`hydro-menu-lock`),G()?.start?.()};s.forEach((e,t)=>{e.addEventListener(`click`,()=>l(t))}),n?.addEventListener(`click`,u),r?.addEventListener(`click`,()=>l((c-1+s.length)%s.length)),i?.addEventListener(`click`,()=>l((c+1)%s.length)),e.addEventListener(`click`,t=>{t.target===e&&u()}),document.addEventListener(`keydown`,t=>{e.classList.contains(`is-open`)&&(t.key===`Escape`&&u(),t.key===`ArrowLeft`&&r?.click(),t.key===`ArrowRight`&&i?.click())})}function $n(e){try{return new URL(e||window.location.href,window.location.origin).href}catch{return window.location.href}}function er(e,t,n){let r=window.getComputedStyle(e)[t];return r&&r!==`rgba(0, 0, 0, 0)`?r:n}function tr(e,t){return $n(t?.dataset.url||e.dataset.shareUrl||window.location.href)}function nr(e,t){return ut(e,{background:er(t,`backgroundColor`,`#f8f5ed`),foreground:er(t,`color`,`#181714`)})}function rr(e,t){return dt(e,{background:er(t,`backgroundColor`,`#f8f5ed`),foreground:er(t,`color`,`#181714`)})}function ir(e){let t=(e||`hydro-moment-poster.png`).trim().replace(/[\\/:*?"<>|]+/g,`-`).replace(/\s+/g,`-`);return t.toLowerCase().endsWith(`.png`)?t:`${t}.png`}function ar(e,t){let n=window.getComputedStyle(e),r=t;for(let e=0;e<n.length;e+=1){let t=n.item(e),i=n.getPropertyValue(t);i.includes(`url(`)||r.style.setProperty(t,i,n.getPropertyPriority(t))}Array.from(e.children).forEach((e,n)=>{let r=t.children.item(n);r&&ar(e,r)})}function or(e){return new Promise((t,n)=>{let r=new FileReader;r.onload=()=>{if(typeof r.result==`string`){t(r.result);return}n(Error(`Poster image reader returned no data URL`))},r.onerror=()=>n(r.error??Error(`Poster image reader failed`)),r.readAsDataURL(e)})}async function sr(e){let t=e.currentSrc||e.src||e.getAttribute(`src`)||``;if(!t)throw Error(`Poster image has no source`);if(t.startsWith(`data:`))return t;let n=new URL(t,window.location.href).href,r=await fetch(n,{credentials:new URL(n).origin===window.location.origin?`same-origin`:`omit`,mode:`cors`});if(!r.ok)throw Error(`Poster image fetch failed with ${r.status}`);return or(await r.blob())}function J(e){return e.replace(/\u00a0/g,` `).replace(/\s+/g,` `).trim()}function cr(e){let t=document.createElement(`div`);return t.innerHTML=e,J(t.textContent||``)}function lr(e){let t=document.createElement(`p`);return t.textContent=e,t}function ur(e){if(!(e instanceof HTMLAnchorElement))return!1;let t=e.getAttribute(`href`)||``;return e.classList.contains(`tag`)||t.includes(`/moments?tag=`)}function dr(e){Array.from(e.querySelectorAll(`p, div, section, article, blockquote, li`)).forEach(e=>{!e.querySelector(`img, video, audio, iframe, canvas, svg`)&&J(e.textContent||``)===``&&e.remove()})}function fr(e,t,n){let r=document.createElement(`div`);if(e&&(r.innerHTML=e.innerHTML),r.querySelectorAll(`audio, button, canvas, embed, figure, iframe, img, object, picture, script, source, style, svg, video`).forEach(e=>{e.remove()}),Array.from(r.querySelectorAll(`a`)).forEach(e=>{if(ur(e)){e.remove();return}e.removeAttribute(`href`),e.removeAttribute(`target`),e.removeAttribute(`rel`)}),dr(r),J(r.textContent||``))return r;let i=cr(t);return r.append(lr(i||n||`一条被认真保存的瞬间`)),r}function pr(e){let t=Array.from(e.querySelectorAll(`[data-hydro-poster-image]`)),n=t.find(e=>!!(e.currentSrc||e.src||e.getAttribute(`src`))),r=e.querySelector(`.hydro-poster-card__media`);return t.forEach(e=>{let t=e===n;e.hidden=!t,e.toggleAttribute(`aria-hidden`,!t)}),r&&(r.hidden=!n,r.toggleAttribute(`aria-hidden`,!n)),e.classList.toggle(`has-poster-image`,!!n),n??null}function mr(e){let t=e.querySelector(`[data-hydro-poster-copy-content]`);if(!t)return;let n=e.querySelector(`[data-hydro-poster-copy-source]`),r=J(t.dataset.hydroPosterCopyFallback||t.textContent||``),i=fr(n,t.dataset.hydroPosterCopyRaw||``,r);t.innerHTML=``,Array.from(i.children).forEach(e=>{t.append(e.cloneNode(!0))}),t.children.length===0&&t.append(lr(J(i.textContent||``)||r))}function hr(e){let t=e.querySelector(`[data-hydro-poster-caption]`);t&&(t.textContent=Array.from(e.querySelectorAll(`[data-hydro-poster-tag]`)).map(e=>J(e.textContent||``)).filter(Boolean).slice(0,2).join(` / `)||J(t.dataset.hydroPosterCaptionFallback||t.textContent||``))}function gr(e){e.querySelectorAll(`[data-hydro-poster-qr]`).forEach(t=>{let n=tr(e,t);t.dataset.hydroPosterQrUrl=n,t.innerHTML=nr(n,t)})}function _r(e){return mr(e),hr(e),gr(e),pr(e)}async function vr(e){let t=new Map,n=Array.from(e.querySelectorAll(`[data-hydro-poster-export-image]`));return await Promise.all(n.map(async(e,n)=>{try{t.set(String(n),await sr(e))}catch(e){console.warn(`[Hydro] Poster image export failed, using local render fallback.`,e)}})),t}async function yr(e,t,n){let r=_r(e),i=await vr(e),a=e.cloneNode(!0);ar(e,a),a.querySelectorAll(`audio, canvas, embed, iframe, object, picture, script, source, style, video`).forEach(e=>{e.remove()});let o=Array.from(a.querySelectorAll(`[data-hydro-poster-image]`));o.forEach((e,t)=>{let n=i.get(String(t));if(r&&n&&t===0){e.src=n,e.hidden=!1,e.removeAttribute(`aria-hidden`),e.style.display=`block`;return}e.remove()}),Array.from(a.querySelectorAll(`[data-hydro-poster-export-image]:not([data-hydro-poster-image])`)).forEach((e,t)=>{let n=i.get(String(o.length+t));if(n){e.src=n;return}let r=e.nextElementSibling;e.remove(),r instanceof HTMLElement&&r.classList.contains(`hydro-poster-card__seal-fallback`)&&r.style.removeProperty(`display`)});let s=a.querySelector(`.hydro-poster-card__media`),c=a.querySelector(`.hydro-poster-card__no-media`);return r&&i.get(`0`)?(a.classList.add(`has-poster-image`),s&&(s.style.display=`block`),c&&(c.style.display=`none`)):(a.classList.remove(`has-poster-image`),s&&(s.style.display=`none`),c&&(c.style.display=`grid`)),a.setAttribute(`xmlns`,`http://www.w3.org/1999/xhtml`),a.style.width=`${t}px`,a.style.height=`${n}px`,a.style.maxWidth=`none`,a.style.margin=`0`,a.style.transform=`none`,a.style.animation=`none`,a.style.transition=`none`,a.querySelectorAll(`*`).forEach(e=>{e.style.animation=`none`,e.style.transition=`none`}),a}function br(e,t){let n=URL.createObjectURL(e),r=document.createElement(`a`);r.href=n,r.download=t,r.rel=`noopener`,document.body.append(r),r.click(),r.remove(),window.setTimeout(()=>URL.revokeObjectURL(n),1e3)}function xr(e){return new Promise((t,n)=>{let r=new Image;r.decoding=`async`,r.onload=()=>t(r),r.onerror=()=>n(Error(`Poster image failed to load`)),r.src=e})}function Sr(e){return new Promise((t,n)=>{e.toBlob(e=>{if(e){t(e);return}n(Error(`Poster canvas export failed`))},`image/png`)})}function Cr(e,t){let n=Number.parseFloat(e||``);return Number.isFinite(n)?n:t}function Y(e,t,n){let r=window.getComputedStyle(e).getPropertyValue(t).match(/[\d.]+/g)?.slice(0,3).map(e=>Number.parseFloat(e));return!r||r.length<3||r.some(e=>!Number.isFinite(e))?n:[r[0],r[1],r[2]]}function X(e,t){return`rgba(${e[0]}, ${e[1]}, ${e[2]}, ${t})`}function wr(){return Math.min(3,Math.max(2,window.devicePixelRatio||2))}function Z(e,t){if(!t)return null;let n=e.getBoundingClientRect(),r=t.getBoundingClientRect();return r.width<=0||r.height<=0?null:{x:r.left-n.left,y:r.top-n.top,width:r.width,height:r.height}}function Tr(e,t){return Z(e,e.querySelector(t))}function Er(e,t,n,r,i,a){let o=Math.max(0,Math.min(a,r/2,i/2));e.beginPath(),e.moveTo(t+o,n),e.lineTo(t+r-o,n),e.quadraticCurveTo(t+r,n,t+r,n+o),e.lineTo(t+r,n+i-o),e.quadraticCurveTo(t+r,n+i,t+r-o,n+i),e.lineTo(t+o,n+i),e.quadraticCurveTo(t,n+i,t,n+i-o),e.lineTo(t,n+o),e.quadraticCurveTo(t,n,t+o,n),e.closePath()}function Dr(e,t,n,r,i=1){Er(e,t.x,t.y,t.width,t.height,n),e.strokeStyle=r,e.lineWidth=i,e.stroke()}function Or(e,t,n,r,i=0){e.save(),Er(e,t.x,t.y,t.width,t.height,i),e.clip(),e.strokeStyle=r,e.lineWidth=1;for(let r=t.y;r<=t.y+t.height;r+=n)e.beginPath(),e.moveTo(t.x,r),e.lineTo(t.x+t.width,r),e.stroke();for(let r=t.x;r<=t.x+t.width;r+=n)e.beginPath(),e.moveTo(r,t.y),e.lineTo(r,t.y+t.height),e.stroke();e.restore()}function kr(e,t,n){let r=t.naturalWidth||t.width,i=t.naturalHeight||t.height;if(r<=0||i<=0)return;let a=Math.max(n.width/r,n.height/i),o=n.width/a,s=n.height/a,c=(r-o)/2,l=(i-s)/2;e.drawImage(t,c,l,o,s,n.x,n.y,n.width,n.height)}function Q(e,t){return e&&window.getComputedStyle(e).font||t}function $(e,t){return e&&window.getComputedStyle(e).color||t}function Ar(e,t){return e?Cr(window.getComputedStyle(e).lineHeight,t):t}function jr(e,t,n){if(e.measureText(t).width<=n)return t;let r=Array.from(t);for(;r.length>0&&e.measureText(`${r.join(``)}...`).width>n;)r.pop();return`${r.join(``).trimEnd()}...`}function Mr(e,t,n,r){let i=J(t);if(!i||r<=0)return[];let a=Array.from(i),o=[],s=0;for(;s<a.length&&o.length<r;){let t=``;for(;s<a.length;){let r=`${t}${a[s]}`;if(!t||e.measureText(r).width<=n){t=r,s+=1;continue}break}o.push(t.trimStart())}return s<a.length&&o.length>0&&(o[o.length-1]=jr(e,o[o.length-1],n)),o}function Nr(e,t,n,r,i,a=`left`){let o=jr(e,J(t),i);e.textAlign=a,e.textBaseline=`top`,e.fillText(o,n,r)}function Pr(e,t,n,r,i,a,o){let s=Mr(e,t,i,o);return s.forEach((t,i)=>{e.fillText(t,n,r+i*a)}),s.length*a}function Fr(e){if(!e)return[];let t=[];if(Array.from(e.children).forEach(e=>{if(!(e instanceof HTMLElement))return;if(e.matches(`ul, ol`)){let n=e.matches(`ol`);Array.from(e.querySelectorAll(`li`)).forEach((e,r)=>{let i=J(e.textContent||``);i&&t.push(`${n?`${r+1}.`:`-`} ${i}`)});return}let n=J(e.textContent||``);n&&t.push(n)}),t.length===0){let n=J(e.textContent||``);n&&t.push(n)}return t}async function Ir(e){if(!e)return null;try{return xr(await sr(e))}catch(e){return console.debug(`[Hydro] Poster image skipped in canvas renderer.`,e),null}}function Lr(e,t,n,r){let i=window.getComputedStyle(t),a=Y(t,`--hydro-paper-rgb`,[245,243,237]),o=Y(t,`--hydro-bg-rgb`,a),s=Y(t,`--hydro-ink-rgb`,[22,22,20]),c=Y(t,`--hydro-accent-rgb`,[129,160,150]),l=Y(t,`--hydro-teal-rgb`,[80,139,126]),u=Cr(i.borderRadius,14),d={x:0,y:0,width:n,height:r};e.save(),Er(e,0,0,n,r,u),e.clip();let f=e.createLinearGradient(0,0,n,r);f.addColorStop(0,X(a,.98)),f.addColorStop(.64,X(a,.9)),f.addColorStop(1,X(o,1)),e.fillStyle=f,e.fillRect(0,0,n,r);let p=e.createRadialGradient(n*.9,r*.14,0,n*.9,r*.14,n*.26);p.addColorStop(0,X(c,.18)),p.addColorStop(1,X(c,0)),e.fillStyle=p,e.fillRect(0,0,n,r);let m=e.createRadialGradient(n*.1,r*.84,0,n*.1,r*.84,n*.28);m.addColorStop(0,X(l,.12)),m.addColorStop(1,X(l,0)),e.fillStyle=m,e.fillRect(0,0,n,r),Or(e,{x:18,y:18,width:n-36,height:r-36},19,X(s,.035)),e.strokeStyle=X(s,.12),e.lineWidth=1,e.strokeRect(17.5,17.5,Math.max(0,n-35),Math.max(0,r-35)),e.save(),e.translate(n-23,r-125),e.rotate(-Math.PI/2),e.fillStyle=X(s,.07),e.font=`700 45px Space Mono, monospace`,e.textBaseline=`top`,e.fillText(`HYDRO`,0,0),e.globalAlpha=.6,e.fillText(`MOMENT`,0,39),e.restore(),Dr(e,d,u,X(s,.16)),e.restore()}async function Rr(e,t,n,r){let i=Y(t,`--hydro-paper-rgb`,[245,243,237]),a=Y(t,`--hydro-ink-rgb`,[22,22,20]),o=Y(t,`--hydro-accent-rgb`,[129,160,150]),s=Cr(window.getComputedStyle(t.querySelector(`.hydro-poster-card__hero`)||t).borderRadius,10),c=await Ir(r);e.save(),Er(e,n.x,n.y,n.width,n.height,s),e.clip();let l=e.createLinearGradient(n.x,n.y,n.x+n.width,n.y+n.height);if(l.addColorStop(0,X(o,.18)),l.addColorStop(.55,X(a,.08)),l.addColorStop(1,X(i,.4)),e.fillStyle=l,e.fillRect(n.x,n.y,n.width,n.height),c){kr(e,c,n);let t=e.createLinearGradient(n.x,n.y,n.x,n.y+n.height);t.addColorStop(0,X(a,.04)),t.addColorStop(1,X(a,.55)),e.fillStyle=t,e.fillRect(n.x,n.y,n.width,n.height)}else Or(e,n,17,X(a,.06),s),e.fillStyle=X(a,.82),e.font=`400 ${Math.min(138,n.height*.64)}px ui-serif, Georgia, serif`,e.textAlign=`center`,e.textBaseline=`middle`,e.fillText(`氢`,n.x+n.width/2,n.y+n.height/2),e.fillStyle=X(a,.28),e.font=`700 12px Space Mono, monospace`,e.textAlign=`right`,e.textBaseline=`top`,e.fillText(`MINIM`,n.x+n.width-16,n.y+n.height-27);e.restore(),Dr(e,n,s,X(a,.14)),e.strokeStyle=X(i,.42),e.lineWidth=1,e.strokeRect(n.x+10.5,n.y+10.5,Math.max(0,n.width-21),Math.max(0,n.height-21));let u=t.querySelector(`[data-hydro-poster-caption]`);u&&(e.fillStyle=c?X(i,.92):X(a,.68),e.font=Q(u,`700 10px Space Mono, monospace`),Nr(e,u.textContent||``,n.x+16,n.y+n.height-29,Math.max(0,n.width-32)))}function zr(e,t){let n=Tr(t,`.hydro-poster-card__copy`),r=t.querySelector(`[data-hydro-poster-copy-content]`),i=Z(t,r),a=t.querySelector(`.hydro-poster-card__kicker`),o=Z(t,a);if(!n||!r||!i)return;let s=Y(t,`--hydro-ink-rgb`,[22,22,20]);e.strokeStyle=X(s,.13),e.lineWidth=1,e.beginPath(),e.moveTo(n.x,n.y+.5),e.lineTo(n.x+n.width,n.y+.5),e.stroke(),a&&o&&(e.fillStyle=$(a,X(s,.44)),e.font=Q(a,`700 11px Space Mono, monospace`),Nr(e,a.textContent||``,o.x,o.y,o.width));let c=Fr(r),l=r.firstElementChild,u=window.getComputedStyle(r).color||X(s,.72),d=i.y,f=i.y+i.height;c.forEach((t,n)=>{if(d>=f-6)return;let a=n===0?l:r,o=n===0?Q(a,`650 25px system-ui, sans-serif`):Q(r,`400 14px system-ui, sans-serif`),c=n===0?Ar(a,29):Ar(r,23),p=Math.max(1,Math.min(n===0?3:2,Math.floor((f-d)/c)));e.fillStyle=n===0?$(a,X(s,.94)):u,e.font=o,e.textAlign=`left`,e.textBaseline=`top`;let m=Pr(e,t,i.x,d,i.width,c,p);d+=m+(n===0?8:7)})}async function Br(e,t){let n=Tr(t,`.hydro-poster-card__footer`),r=Tr(t,`.hydro-poster-card__seal`),i=Tr(t,`.hydro-poster-site`),a=t.querySelector(`[data-hydro-poster-qr]`),o=Z(t,a);if(!n||!r||!i)return;let s=Y(t,`--hydro-ink-rgb`,[22,22,20]);e.strokeStyle=X(s,.1),e.lineWidth=1,e.beginPath(),e.moveTo(n.x,n.y+.5),e.lineTo(n.x+n.width,n.y+.5),e.stroke();let c=await Ir(t.querySelector(`[data-hydro-poster-avatar]`)),l=r.x+r.width/2,u=r.y+r.height/2,d=Math.min(r.width,r.height)/2;if(e.save(),e.beginPath(),e.arc(l,u,d,0,Math.PI*2),e.clip(),e.fillStyle=X(s,.05),e.fillRect(r.x,r.y,r.width,r.height),c&&kr(e,c,r),e.restore(),e.beginPath(),e.arc(l,u,d-.5,0,Math.PI*2),e.strokeStyle=X(s,.18),e.stroke(),!c){let n=t.querySelector(`.hydro-poster-card__seal-fallback`);e.fillStyle=$(n,X(s,.78)),e.font=Q(n,`700 16px system-ui, sans-serif`),e.textAlign=`center`,e.textBaseline=`middle`,e.fillText(J(n?.textContent||`H`),l,u)}e.strokeStyle=X(s,.12),e.beginPath(),e.moveTo(i.x+.5,i.y),e.lineTo(i.x+.5,i.y+i.height),e.stroke();let f=t.querySelector(`.hydro-poster-site strong`),p=t.querySelector(`.hydro-poster-site span`),m=t.querySelector(`.hydro-poster-site em`),h=Z(t,f),g=Z(t,p),_=Z(t,m);if(f&&h&&(e.fillStyle=$(f,X(s,.95)),e.font=Q(f,`700 14px system-ui, sans-serif`),Nr(e,f.textContent||``,h.x,h.y,h.width)),p&&g&&(e.fillStyle=$(p,X(s,.46)),e.font=Q(p,`400 11px system-ui, sans-serif`),Nr(e,p.textContent||``,g.x,g.y,g.width)),m&&_&&(e.fillStyle=$(m,X(s,.62)),e.font=Q(m,`700 10px Space Mono, monospace`),Nr(e,m.textContent||``,_.x,_.y,_.width)),a&&o)try{let n=await xr(rr(a.dataset.hydroPosterQrUrl||tr(t,a),a));e.drawImage(n,o.x,o.y,o.width,o.height)}catch(e){console.debug(`[Hydro] Poster QR skipped in canvas renderer.`,e)}}async function Vr(e,t,n){_r(e);try{await document.fonts?.ready}catch{}let r=wr(),i=document.createElement(`canvas`);i.width=Math.ceil(t*r),i.height=Math.ceil(n*r);let a=i.getContext(`2d`);if(!a)throw Error(`Poster canvas context is unavailable`);a.scale(r,r),Lr(a,e,t,n);let o=e.querySelector(`.hydro-poster-card__header`),s=e.querySelector(`.hydro-poster-card__eyebrow`),c=e.querySelector(`.hydro-poster-card__header time`),l=Z(e,o),u=Z(e,s),d=Z(e,c);l&&s&&u&&(a.fillStyle=$(s,`rgba(22, 22, 20, 0.58)`),a.font=Q(s,`700 12px Space Mono, monospace`),Nr(a,s.textContent||``,u.x,u.y,u.width)),l&&c&&d&&(a.fillStyle=$(c,`rgba(22, 22, 20, 0.46)`),a.font=Q(c,`400 10px Space Mono, monospace`),Nr(a,c.textContent||``,d.x+d.width,d.y,d.width,`right`));let f=_r(e),p=Tr(e,`.hydro-poster-card__hero`);return p&&await Rr(a,e,p,f),zr(a,e),await Br(a,e),Sr(i)}async function Hr(e,t,n){let r=await yr(e,t,n),i=`<svg xmlns="http://www.w3.org/2000/svg" width="${t}" height="${n}" viewBox="0 0 ${t} ${n}"><foreignObject width="100%" height="100%">${new XMLSerializer().serializeToString(r)}</foreignObject></svg>`,a=new Blob([i],{type:`image/svg+xml;charset=utf-8`}),o=URL.createObjectURL(a);try{let e=await xr(o),r=Math.min(3,Math.max(2,window.devicePixelRatio||2)),i=document.createElement(`canvas`);i.width=Math.ceil(t*r),i.height=Math.ceil(n*r);let a=i.getContext(`2d`);if(!a)throw Error(`Poster canvas context is unavailable`);return a.scale(r,r),a.drawImage(e,0,0,t,n),await Sr(i)}finally{URL.revokeObjectURL(o)}}async function Ur(e,t){let n=e.getBoundingClientRect(),r=Math.ceil(n.width||e.offsetWidth),i=Math.ceil(n.height||e.offsetHeight);if(r<=0||i<=0)throw Error(`Poster card has no exportable size`);let a=ir(t);try{br(await Hr(e,r,i),a);return}catch(e){console.debug(`[Hydro] Poster DOM export failed, using canvas renderer.`,e)}br(await Vr(e,r,i),a)}function Wr(e){e.querySelectorAll(`[data-hydro-poster-card]`).forEach(e=>{_r(e)}),e.querySelectorAll(`[data-hydro-poster-download]`).forEach(t=>{t.addEventListener(`click`,async()=>{let n=e.querySelector(`[data-hydro-poster-card]`);if(n){t.disabled=!0,t.classList.add(`is-downloading`),t.setAttribute(`aria-busy`,`true`);try{await Ur(n,ir(t.dataset.filename))}catch(e){console.warn(`[Hydro] Poster PNG export failed.`,e),K(`海报 PNG 生成失败，请稍后再试`,{id:`hydro-poster-download`,title:`分享海报`,variant:`error`})}finally{t.disabled=!1,t.classList.remove(`is-downloading`),t.removeAttribute(`aria-busy`)}}})})}function Gr(){new Set(Array.from(document.querySelectorAll(`[data-hydro-poster-scope]`))).forEach(e=>Wr(e))}function Kr(){document.querySelectorAll(`[data-hydro-filter-root]`).forEach(e=>{let t=Array.from(e.querySelectorAll(`[data-hydro-plugin-filter]`)),n=Array.from(e.querySelectorAll(`[data-hydro-filter-group]`));t.length===0||n.length===0||t.forEach(e=>{e.addEventListener(`click`,()=>{let r=e.dataset.hydroPluginFilter||`all`;t.forEach(t=>t.classList.toggle(`is-active`,t===e)),n.forEach(e=>{let t=r===`all`||e.dataset.hydroFilterGroup===r;e.toggleAttribute(`hidden`,!t)})})})})}function qr(){let e=document.querySelector(`[data-hydro-doc-content]`)||document.querySelector(`[data-toc-content]`)||document.querySelector(`#content`),t=document.querySelector(`[data-hydro-doc-toc]`);if(!e||!t)return;let n=t.closest(`.hydro-doc-toc`),r=()=>{if(!n)return null;let e=n.querySelector(`.hydro-doc-toc__meta`);return e||(e=document.createElement(`div`),e.className=`hydro-doc-toc__meta`,n.insertBefore(e,t)),e},i=(e,t=`0`,n=``)=>{let i=r();if(!i)return;i.innerHTML=``;let a=document.createElement(`span`);a.className=`hydro-doc-toc__meta-summary`,a.textContent=e>0?`${t} / ${String(e).padStart(2,`0`)}`:`0 / 00`;let o=document.createElement(`strong`);o.className=`hydro-doc-toc__meta-current`,o.textContent=n||`暂无章节`,i.append(a,o)},a=Array.from(e.querySelectorAll(`h1, h2, h3, h4, h5`)).filter(e=>(e.textContent||``).trim().length>0);if(n?.style.setProperty(`--hydro-doc-toc-progress`,`0%`),n?.setAttribute(`data-toc-count`,String(a.length)),a.length===0){i(0),t.innerHTML=`<span class="hydro-doc-toc__empty">${q(document.body.dataset.docTocEmptyText||`无目录`)}</span>`;return}let o=new Set;t.innerHTML=``;let s=[],c=a.map(e=>Number.parseInt(e.tagName.replace(`H`,``),10)||1),l=Math.min(...c),u=Math.max(...c),d=Array.from({length:7},()=>0),f=[];n?.setAttribute(`data-toc-depth-min`,String(l)),n?.setAttribute(`data-toc-depth-max`,String(u));let p=e=>{let t=Math.min(5,Math.max(l,e));for(let e=l;e<t;e+=1)d[e]===0&&(d[e]=1);d[t]+=1;for(let e=t+1;e<d.length;e+=1)d[e]=0;return d.slice(l,t+1).join(`.`)};a.forEach((e,n)=>{let r=c[n]||l,u=p(r),d=Math.min(5,Math.max(1,r-l+1)),m=Tn(e.textContent||``,n).replace(/^post-/,`doc-`),h=e.id||m,g=2;for(;o.has(h);)h=`${m}-${g}`,g+=1;o.add(h),e.id=h;let _=document.createElement(`a`);_.href=`#${h}`,_.dataset.depth=String(r),_.dataset.rank=String(d),_.dataset.number=u,_.dataset.index=String(n+1).padStart(2,`0`);let v=document.createElement(`span`);v.className=`hydro-doc-toc__link-index`,v.textContent=u;let y=document.createElement(`span`);y.className=`hydro-doc-toc__link-label`,y.textContent=(e.textContent||``).trim(),_.append(v,y),_.addEventListener(`click`,t=>{t.preventDefault(),s.forEach(e=>e.classList.toggle(`is-active`,e===_)),i(a.length,u,y.textContent||``),nn(e)}),t.append(_),s.push(_),f.push(u)});let m=-1,h=!1,g=e=>{let n=t.getBoundingClientRect(),r=e.getBoundingClientRect();(r.top<n.top+12||r.bottom>n.bottom-12)&&e.scrollIntoView({block:`nearest`,inline:`nearest`})},_=()=>{let e=window.scrollY+Math.round(window.innerHeight*.24),t=a.reduce((t,n,r)=>n.offsetTop<=e?r:t,0),r=a[0]?.offsetTop??0,o=a[a.length-1]?.offsetTop??r,c=Math.max(1,o-r),l=Math.min(1,Math.max(0,(e-r)/c));if(n?.style.setProperty(`--hydro-doc-toc-progress`,`${Math.round(l*100)}%`),s.forEach((e,n)=>e.classList.toggle(`is-active`,n===t)),m!==t){m=t;let e=s[t],n=a[t]?.textContent?.trim()||``;i(a.length,f[t]||`0`,n),e&&g(e)}},v=()=>{h||(h=!0,window.requestAnimationFrame(()=>{h=!1,_()}))};_(),window.addEventListener(`scroll`,v,{passive:!0}),window.addEventListener(`resize`,v)}function Jr(){document.querySelectorAll(`.hydro-doc-tree li`).forEach(e=>{let t=e.querySelector(`:scope > a, :scope > details > summary > a`);if(!t)return;let n=0,r=t.closest(`ul`);for(;r?.parentElement?.closest(`.hydro-doc-tree ul`);)n+=1,r=r.parentElement.closest(`.hydro-doc-tree ul`);t.dataset.docNodeType=e.querySelector(`:scope > details`)?`tree`:`doc`,t.dataset.docTreeDepth=String(n)})}function Yr(){let e=document.querySelector(`[data-hydro-steam]`);if(!e)return;let t=`hydro-steam-cache`,n=Math.max(0,Qt(e.dataset.cacheTtlMinutes,3))*60*1e3,r=Number.parseInt(e.dataset.recentLimit||`8`,10),i=Number.parseInt(e.dataset.pageSize||`18`,10),a=e.dataset.enableGameLink!==`false`,o=e.dataset.emptyText||`暂无 Steam 游戏数据`,s=e.dataset.errorText||`Steam 数据暂时不可用`,c=e.dataset.syncHintText||`请确认 plugin-steam 已同步账号数据。`,l=e.dataset.configHintText||`请确认 plugin-steam 已启用，并已填写 Steam ID/API 配置。`,u=e.dataset.libraryLoadingText||`正在加载游戏库。`,d=e.querySelector(`[data-steam-error]`),f=e.querySelector(`[data-steam-avatar]`),p=e.querySelector(`[data-steam-name]`),m=e.querySelector(`[data-steam-status]`),h=e.querySelector(`[data-steam-level]`),g=e.querySelector(`[data-steam-recent]`),_=e.querySelector(`[data-steam-games]`),v=e.querySelector(`[data-steam-pagination]`),y=e.querySelector(`[data-steam-prev]`),b=e.querySelector(`[data-steam-next]`),x=e.querySelector(`[data-steam-page]`),ee=e=>{try{let n=window.localStorage.getItem(`${t}:${e}`);if(!n)return null;let r=JSON.parse(n);return r.expires<Date.now()?(window.localStorage.removeItem(`${t}:${e}`),null):r.value}catch{return null}},te=(e,r)=>{if(!(n<=0))try{window.localStorage.setItem(`${t}:${e}`,JSON.stringify({expires:Date.now()+n,value:r}))}catch{}},S=async(e,t=!0)=>{let n=e.replace(/[^a-z0-9]/gi,`_`),r=t?ee(n):null;if(r)return r;let i=await window.fetch(`/apis/api.steam.timxs.com/v1alpha1${e}`);if(!i.ok)throw Error(`Steam API ${e} failed with ${i.status}`);let a=await i.json();return t&&te(n,a),a},C=(e,t,n=``)=>{e&&(e.innerHTML=`<div class="hydro-plugin-empty hydro-plugin-empty--small">
      ...
      ${n?`<p>${q(n)}</p>`:``}
          ...
          <span class="hydro-game-card__media">
            <img src="${q(n||un(i))}" alt="${i}" loading="lazy" />
          </span>
          <strong>${i}</strong>
          <span>${o}</span>
        </a>`}).join(``),e.querySelectorAll(`img`).forEach(e=>{e.addEventListener(`error`,()=>{e.src=un(e.alt||`Steam`)},{once:!0})})},E=e=>{let t=e.page||1,n=e.totalPages||1;x&&(x.textContent=`${t} / ${n}`),y&&(y.disabled=t<=1),b&&(b.disabled=t>=n),v&&(v.hidden=n<=1)},D=async e=>{_&&C(_,u);try{let t=await S(`/games?page=${e}&size=${i}`,!1);T(_,t.items||[],o),E(t)}catch{C(_,s,l),d?.removeAttribute(`hidden`)}};Promise.allSettled([S(`/profile`),S(`/stats`),S(`/badges`),S(`/recent?limit=${r}`)]).then(([t,n,r,i])=>{if(t.status===`fulfilled`){let e=t.value,n=e.summary?.avatarfull;f&&(f.innerHTML=n?`<img src="${q(n)}" alt="${q(e.summary?.personaname||`Steam`)}" />`:`<span>ST</span>`),p&&(p.textContent=e.summary?.personaname||`Steam User`),m&&(m.textContent=e.statusText||(e.playing?`Playing`:`Steam profile`))}else d?.removeAttribute(`hidden`);if(n.status===`fulfilled`){let t=n.value,r=e.querySelector(`[data-steam-stat='games']`),i=e.querySelector(`[data-steam-stat='total']`),a=e.querySelector(`[data-steam-stat='recent']`);r&&(r.textContent=String(t.totalGames||0)),i&&(i.textContent=ln(t.totalPlaytimeMinutes)),a&&(a.textContent=ln(t.recentPlaytimeMinutes))}r.status===`fulfilled`&&h&&(h.textContent=`Lv. ${r.value.playerLevel||0}`),i.status===`fulfilled`?T(g,i.value,o,!0):C(g,s,l)}),y?.addEventListener(`click`,()=>{let e=Number.parseInt(x?.textContent?.split(`/`)[0]?.trim()||`1`,10);e>1&&D(e-1)}),b?.addEventListener(`click`,()=>{let[e,t]=x?.textContent?.split(`/`)||[`1`,`1`],n=Number.parseInt(e.trim(),10);n<Number.parseInt(t.trim(),10)&&D(n+1)}),D(1)}Jn(),qn(),Xn(),Zn(),Yn(),Qn(),Gr(),Kr(),Jr(),Pn(),qr(),Yr();function Xr(){let e=document.querySelector(`[data-hydro-back-to-top]`);if(!e)return;let t=Qt(document.body.dataset.backToTopThreshold,100),n=()=>e.classList.toggle(`is-visible`,window.scrollY>t);n(),window.addEventListener(`scroll`,n,{passive:!0}),e.addEventListener(`click`,()=>{tn(0)})}function Zr(){let e=document.querySelector(`[data-hydro-fab-trigger]`),t=document.querySelector(`[data-hydro-fab]`);if(!e||!t)return;let n=Array.from(t.querySelectorAll(`.hydro-fab-item`));if(n.length===0)return;let r=window.matchMedia(`(hover: hover) and (pointer: fine)`).matches,i=Math.ceil(48/80*(180/Math.PI)),a=Math.max(i,25),o=(n.length-1)/2*a,s=Math.min(225,270-o);n.forEach((e,t)=>{let r=(s+(t-(n.length-1)/2)*a)*Math.PI/180;e.style.setProperty(`--fab-x`,`${Math.round(Math.cos(r)*80)}px`),e.style.setProperty(`--fab-y`,`${Math.round(Math.sin(r)*80)}px`)});let c,l=()=>{window.clearTimeout(c),t.classList.add(`is-open`),e.setAttribute(`aria-expanded`,`true`)},u=()=>{window.clearTimeout(c),t.classList.remove(`is-open`),e.setAttribute(`aria-expanded`,`false`)},d=()=>{c=window.setTimeout(()=>{u()},300)},f={copyText:e=>rn(e),getWindow:()=>window,isMemberAuthenticated:on,isMemberPluginAvailable:an,notify:(e,t)=>K(e,t),root:document,scrollToElement:nn,scrollToPosition:tn,warn:e=>console.warn(e)};r&&(e.addEventListener(`mouseenter`,l),e.addEventListener(`mouseleave`,d),n.forEach(e=>{e.addEventListener(`mouseenter`,l),e.addEventListener(`mouseleave`,d)})),n.forEach(e=>{e.addEventListener(`click`,t=>{ce(e,t,f,u)})}),e.addEventListener(`click`,e=>{if(e.stopPropagation(),t.classList.contains(`is-open`)){u();return}l()}),document.addEventListener(`click`,n=>{!t.contains(n.target)&&n.target!==e&&u()})}Xr(),Zr(),Ft();