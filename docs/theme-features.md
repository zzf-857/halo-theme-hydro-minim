...
> 氢·简 Hydro-Minim，一款轻盈、克制、结构化的 Halo 极简博客主题。

应用市场简介：

> Hydro-Minim 是“氢”系列首款 Halo 主题，以灰白纸面、细线、轻颗粒、低饱和强调色和流畅动效呈现内容。主题覆盖首页、文章、分类、标签、归档、搜索、友链、瞬间、图库、Docsme 文档、Steam 等页面，并提供深浅色切换、阅读进度、移动端阅读条、分享海报、插件缺失提示和页面级快捷操作配置。适合独立创作者、技术博客和重视阅读体验的内容站。

三句话卖点：

1. 轻：灰白纸面、细线、低饱和色和轻颗粒，做出有识别度但不过度装饰的博客气质。
2. 稳：文章、分类、标签、归档、搜索和插件页都有空状态兜底，不让插件缺失拖垮前台。
3. 活：Hero、导航收缩、主题光幕、文章阅读条、分享海报和快捷操作，让极简主题也有完整互动。
